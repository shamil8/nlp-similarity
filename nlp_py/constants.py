...
MIN_COUNT_WORDS = 3       # Минимальное кол-во совпадающих слов в NLP и слов в данной задачи (если в задачи меньше слов чем здесь, то данная переменная уменьшается на 1)
